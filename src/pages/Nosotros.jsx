...
const Nosotros = () => {
  const pilares = [
    {
      ...
      content:
        "Alaluf nació como una empresa familiar y sigue siéndolo. Porque creemos que la mejor forma de cuidar el patrimonio de nuestros clientes es tratarlo exactamente como tratamos el nuestro: con criterio, con visión de largo plazo y con la responsabilidad de quien sabe que cada decisión importa.",
    },
    {
      id: "02",
      title: "TRAYECTORIA Y EXPERTISE",
      content:
        "En 45 años hemos visto cómo el mercado inmobiliario chileno cambia de ciclo, cómo llegan y van las tendencias, cómo aparecen nuevos actores y desaparecen otros. Nosotros seguimos aquí. Porque conocemos el mercado en profundidad, hemos construido relaciones que duran décadas y hemos cerrado las operaciones más complejas del mercado con éxito.",
    },
    {
      id: "03",
      title: "EQUIPO Y COMPROMISO",
      content:
        "Detrás de cada operación hay personas que conocen su área con profundidad y que entienden que su rol no es mostrarte propiedades — sino acompañarte a tomar la mejor decisión. Eso es lo que somos. Una familia que lleva 45 años haciendo bien lo que sabe hacer — y que no necesitó volverse franquicia para probarlo.",
    },
  ];
  ...
  const teamMembers = [
    {
      ...
      image: jackImage,
      email: "jack@alaluf.com",
    },
    {
      name: "Leonor Alvo",
      title: "Gerente Industrial",
      image: leonorImage,
      email: "lalvo@alaluf.com",
    },
    {
      name: "Alejandra Alaluf",
      title: "Gerente General",
      image: alejandraImage,
      email: "alejandra@alaluf.com",
    },
    {
      name: "Natalie Alaluf",
      title: "Coordinadora Comercial e Industrial",
      image: natalieImage,
      email: "natalie@alaluf.com",
    },
    {
      name: "Sebastian Casals",
      title: "Gerente Comercial",
      image: danielImage,
      email: "scasals@alaluf.com",
    },
  ];
  ...
  const crearDatosCorreo = ({ email, name }) => {
    ...
    return {
      ...
      gmail: `https://mail.google.com/mail/?view=cm&fs=1&to=${destinatario}&su=${asunto}&body=${cuerpo}`,
    };
  };

  const abrirCorreo = (event, contacto) => {
    ...
    window.addEventListener("blur", marcarComoAbierto, { once: true });
    document.addEventListener("visibilitychange", marcarComoAbierto, {
      once: true,
    });
      ...
      <section className="pt-2 pb-10 px-4 sm:px-6 md:px-12 relative z-10 text-white">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed max-w-6xl mx-auto mb-12 sm:mb-16 md:mb-20 text-gray-100 font-medium drop-shadow-sm space-y-5 px-2 text-justify sm:text-center">
            <p>
              Alaluf nació como una empresa familiar y sigue siéndolo. En todo
              este tiempo construimos lo que ningún actor nuevo puede comprar:
              el conocimiento profundo del mercado inmobiliario chileno, como
              asimismo, relaciones de años con personas y grandes grupos
              corporativos siempre con una visión de largo plazo y la
              responsabilidad de quien sabe que Hemos vivido abiertos al cambio
              y a la innovación.
            </p>

            <p>
              Hemos visto llegar y partir tendencias, aparecer nuevos actores y
              desaparecer otros. Nosotros seguimos aquí — porque conocemos el
              mercado en profundidad y hemos cerrado las operaciones más
              complejas de Chile con éxito. Detrás de cada operación hay
              personas que conocen su área con profundidad y entienden que su
              rol no es mostrarte propiedades — sino acompañarte a tomar la
              mejor decisión. Somos una familia que entiende lo que significa
              construir algo propio. Y eso, con la inteligencia de hoy, lo
              hacemos mejor que nunca.
            </p>
          </div>
        ...
        <div className="bg-[#e9e9e9] p-6 sm:p-8 md:p-10 lg:p-12 rounded-2xl shadow-xl w-full lg:absolute lg:right-4 xl:right-16 lg:top-8 lg:w-[480px] xl:w-[550px] z-20 mt-2 lg:mt-0 text-center lg:text-start">
          ...
          <p className="text-sm md:text-base lg:text-lg text-gray-600 leading-relaxed font-light mb-6">
            <span className="font-bold text-black block sm:inline">
              Lo primero es entenderte a ti:
            </span>{" "}
            tus objetivos, tu situación y asesorarte en el camino más
            inteligente para llegar donde quieres.
          </p>

          <a
            href={crearDatosCorreo({
              email: "contacto@alaluf.com",
              name: "",
            }).mailto}
            onClick={(event) =>
              abrirCorreo(event, {
